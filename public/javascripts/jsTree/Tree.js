function ClassTree() {
    ...
    this.ajax_file = "../../../public/php/jsTree/tree_server.php";
    this.tree_image_path = "../../../public/img/";

}



ClassTree.prototype.setDivId = function(div_id) {

    this.div_id = div_id;

};
ClassTree.prototype.setUpHTMLFixture = function() {
...
function Folder() {
    ...
    var tree_image_path = this.tree_image_path;
...
ClassTree.prototype.start = function() {
    if (!this.class_login.checkIfUserIsStillLoggedIn()) {
        return this.displayLoginMessage();
    }
    this.iniTree();
    this.addListener();
};

ClassTree.prototype.displayLoginMessage = function() {

    $("#" + this.div_id).html("Melde dich bitte erst an bevor du weitermachst.");

};
ClassTree.prototype.addListener = function() {
...
ClassTree.prototype.iniTree = function() {
                ...
                "ajax": {
                    ...
                    "data": function(n) {
                        return {
                            ...
                            "id": n.attr ? n.attr("id").replace("node_", "") : 1483
                        };
                    }
                }
            },
    ...
    $("#" + this.div_id).bind("create.jstree", function(e, data) {
            ...
            $.post(
                ajax_file, {
                    "operation": operation,
                    "list_id": data.rslt.parent.attr("id").replace("node_", ""),
        ...
        .bind("rename.jstree", function(e, data) {
            $.post(
                ajax_file, {
                    ...
                    "list_id": data.rslt.obj.attr("id").replace("node_", ""),
        ...
        .bind("move_node.jstree", function(e, data) {
            data.rslt.o.each(function(i) {
                $.ajax({
                    ...
                    data: {
                        "operation": "move_node",
                        "list_id": $(this).attr("id").replace("node_", ""),
