    ...
    (function($) {
        ...
        $(function() {
            ...
            var u = navigator.userAgent.toLowerCase(),
                ...
                '.jstree a { display:inline-block; line-height:16px; height:16px; color:black; white-space:nowrap; text-decoration:none; padding:1px 2px; } ' +
        ...
        $.jstree.plugin("checkbox", {
            ...
            _fn: {
                ...
                _prepare_checkboxes: function(obj) {
                    ...
                    var c, _this = this,
                        t, ts = this._get_settings().checkbox.two_state,
